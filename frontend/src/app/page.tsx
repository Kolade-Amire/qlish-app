        ...
        <div>
            ...
            <div>
                    ...
                    <div className="flex flex-col lg:flex-row justify-center items-center max-w-5xl mx-auto">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-[#878686] text-xl">
                                Create custom quizzes instantly by uploading documents, or explore a vast range of
                                quizzes on academic
                                subjects,
                ...
                <section className="container max-w-5xl mx-auto py-12 px-4 md:px-6 md:py-16 ">
                    ...
                    <div
                        className="flex flex-col lg:space-x-8 lg:space-y-0 space-y-8 lg:flex-row justify-center items-center max-w-5xl mx-auto">
                        {[
