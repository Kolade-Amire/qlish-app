    ...
    return (
        <div className="h-full flex flex-col justify-center items-center">
            ...
            <form className="space-y-4 w-90">
                <button
                    className="w-full h-full bg-transparent border border-[#ABABAB] py-2 rounded flex items-center cursor-pointer justify-center">
                ...
                <input type="email" placeholder="Your email*"
                       className="w-full p-2 border border-[#ABABAB] rounded focus:border-2 focus:border-[#994040] focus:outline-none"/>
                ...
                <input type="password" placeholder="Confirm password*"
                       className="w-full  p-2 border border-[#ABABAB] focus:border-2 focus:border-[#994040] focus:outline-none rounded"/>
                <button type="submit"
                        className="w-full cursor-pointer bg-[#2C3E50] text-[#FFF0D3] py-2 rounded">
                    Sign up
                </button>
            </form>
        </div>
