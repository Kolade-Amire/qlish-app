...
public enum TestSub {
    ...
    GENERAL_KNOWLEDGE(Map.of(
            ...
            DifficultyLevel.INTERMEDIATE, Set.of("celebrities", "pop culture and entertainment", "countries & capitals"),
            DifficultyLevel.ADVANCED, Set.of("pop culture and entertainment", "current affairs")
    ));

    private final Map<DifficultyLevel, Set<String>> topicsByDifficulty;


    public Set<String> getTopicsForDifficulty(DifficultyLevel level) {
        return topicsByDifficulty.getOrDefault(level, Set.of());
    }
    }
